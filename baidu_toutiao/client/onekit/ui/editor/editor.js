Component({
  ...
  didMount() {
    ...
    nodes = '<p swan:nodeid="47">aaaa<span style="color: rgb(0, 0, 255);" swan:nodeid="65">aaaaaa</span>aa<span style="background-color: rgb(0, 255, 0);">a</span>aa</p>';
  ...
  editor_tap(){
    swan.navigateTo({url:"/onekit/ui/editor/web/web"});
  }
  }
});
